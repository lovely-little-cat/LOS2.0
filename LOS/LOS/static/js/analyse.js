...
document.addEventListener('DOMContentLoaded', () => {
  // 创建图表管理器实例
  const profitChartManager = new ProfitChartManager();
  
  // 初始化（触发完整生命周期）
  profitChartManager.init();
